...
cass=".------------------------.\n"
cass="$cass|\\\\////////               |\n"
cass="$cass| \/  __  ______  __     |\n"
cass="$cass|    /  \|\.....|/  \    |\n"
cass="$cass|    \__/|/_____|\__/    |\n"
cass="$cass| Amazing                |\n"
cass="$cass|    ________________    |\n"
cass="$cass|___/_._o________o_._\___|\n"
# art by Conspiracy Duck
...
films=( 'Les évadés 1994' #1 
	...
	'Inception 2010' #13
	"L'empire contre-attaque 1980" #14
	'Le seigneur des anneaux: Les deux tours 2002' #15
	'Matrix 1999' #16
	...
	'Le Roi Lion 1994' #35
	'American History X 1998' #36
	'Retour vers le futur 1985' #37
	'Terminator 2 - Le jugement dernier 1991' #38
	'Le pianiste 2002' #39
	'Les temps modernes 1936' #40
	'1917 2019' #41
	'Psychose 1960' #42
	'Gladiator 2000' #43
	...
	'Memento 2000' #57
	'Le dictateur 1940' #58
	'La vie des autres 2006' #59
	'Django Unchained 2012' #60
	'Avengers: Endgame 2019' #61
	'Avengers: Infinity War 2018' #62
	'Shining 1980' #63
	...
	'Coco 2017' #77
	'Braveheart 1995' #78
	"Entre le ciel et l'enfer 1963" #79
	'Le bateau 1981' #80
	'3 Idiots 2009' #81
	'Le retour du Jedi 1983' #82
	'Taare Zameen Par 2007' #83
	'Toy Story 1995' #84
	'Amadeus 1984' #85
	...
	'Green Book: Sur les routes du sud 2018' #129
	'La chute 2004' #130
	...
	'Le Mans 66 2019' #140
	'Casino 1995' #141
	'Le labyrinthe de Pan 2006' #142
	'Raging Bull 1980' #143
	...
	'Luke la main froide 1967' #202
	'Into the Wild 2007' #203
	'Le salaire de la peur 1953' #204
	'Network - Main basse sur la TV 1976' #205
	'Stand by me - Compte sur moi 1986' #206
	'Mad Max: Fury Road 2015' #207
	'Monty Python: La Vie de Brian 1979' #208
	'Platoon 1986' #209
	'Barry Lyndon 1975' #210
	'Million Dollar Baby 2004' #211
	"La passion de Jeanne d'Arc 1928" #212
	'Hatchi 2009' #213
	'Rush 2013' #214
	'Logan 2017' #215
	'Ben-Hur 1959' #216
	...
	'Lagaan 2001' #235
	'Princess Bride 1987' #236
	'Gangs of Wasseypur 2012' #237
	'Before Sunset 2004' #238
	'In the Mood for Love 2000' #239
	'La couleur des sentiments 2011' #240
	'Butch Cassidy et le Kid 1969' #241
	'Terminator 1984' #242
	'P.K. 2014' #243
	'Akira 1988' #244
...
longueur=${#films[@]}
randomNum=$((1 + RANDOM % $longueur))

currentNum=$(($randomNum - 1))
note=0
...
numQuestions=$numDemande

while [ $numQuestions -gt 0 ]
do
	currentString=${films[currentNum]}
	currentYear=${currentString: -4}
	...
	if [ "$input" == "$currentYear" ]; then
		echo "$currentYear oui!"
		note=$(( $note + 1 )) 
	else
		printf "${CYAN}$currentYear${NC} was the right answer\n"
	fi

	echo "#$(($currentNum + 1))"
	currentNum=$((($currentNum + 1) % longueur))
